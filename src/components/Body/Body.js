      ...
      <div className="Elixir-container" data-aos='fade-up'  data-aos-once = "true">
            ...
            <div className='choose-grid'>
              <div className='choose-box1'>
                  <img src={'https://prium.github.io/elixir/assets/images/why-choose-us.jpg'} alt='why-choose-us-image' className='choose-image'/>
              </div>
                ...
                <div  data-aos='fade-up'  data-aos-once = "true">
                  <div className="foot-text">
                    ...
                    <div className="foot-text-right">
                     <a href="https://www.linkedin.com/in/shasere-elijah-2a7174293/" target='_blank'>
                     ...
                     <a href="https://twitter.com/Deflows_" target='_blank'>
                      <div className="social-flex">
                        <div className="social-icon">
